#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────
# deploy.sh — push the COS NYFW Showroom venue proposal deck
# to GitHub Pages
#
# What this does:
...
DEFAULT_REPO_NAME="cocoon-cos-nyfw-showroom"
...
if ! git diff --cached --quiet; then
  git commit -q -m "COS NYFW Showroom — venue proposal · September 8–14, 2026"
fi
